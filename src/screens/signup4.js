  ...
  return (
    <SafeAreaView  style={styles.container}>
        ...
        <View style={styles.canvas}>
            ...
            <View style={{flex :2}}>
                <View style={{flex :1, justifyContent: 'center'}}>
                    <Text style={styles.buttonUpperText}>Address Line 1</Text>
                        <TextInput 
                ...
                <View style={{flex :1, justifyContent: 'center'}}>
                    <Text style={styles.buttonUpperText}>Address Line 2</Text>
                        <TextInput 
                            style={styles.textinput}
                            autoCorrect = {true}
                            secureTextEntry = {true}
                ...
                <View style={{flex :1, justifyContent: 'center'}}>
                    <Text style={styles.buttonUpperText}>Address Line 3</Text>
                        <TextInput 
                            style={styles.textinput}
                            autoCorrect = {true}
                            secureTextEntry = {true}
                ...
                <View style={{flex :1, justifyContent: 'center'}}>
                    <Text style={styles.buttonUpperText}>Upload a billing proof</Text>

                    <View style={styles.buttonView}>
                    <TouchableOpacity style={styles.loginButton}>
                        <Text style={styles.loginButtonText}>Upload Proof</Text>
                    </TouchableOpacity>
                    </View>
                </View>
                <View style={{flex :1, justifyContent: 'center'}}>
                    <Text style={styles.buttonUpperText}>Upload Bank Passbook Account Details Side (Optional)</Text>
